...
import { SECTIONS, SECTION_IDS, sectionNumber } from "./sections";
...
export default function Portfolio() {
  ...
  return (
    <div className="relative min-h-screen bg-crt-bg font-[Inter,system-ui,sans-serif] text-[15px] leading-relaxed text-crt-ink antialiased">
      ...
      <SideNav items={navItems} activeHref={`#${activeId}`} />
      ...
      <main className="relative z-10 lg:pl-56">
        ...
        <Section id="gallery" delay="crt-d5">
          <CrtGallery images={gallery} alt="Gallery photo" />
        </Section>
