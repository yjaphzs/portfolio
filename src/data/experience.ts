    ...
    roles: [
      {
        ...
        bullets: [
          "Lead full-stack development across multiple product teams, owning architecture and delivery.",
          "Ship subscription billing and credit-metered usage — checkout, payment webhooks, and entitlement enforcement across the portal.",
          "Build Firebase applications end to end: authentication, database, storage, serverless functions, and hosting.",
          "Ship Next.js front ends on Python FastAPI services, backed by a managed SQL data layer.",
          "Integrate e-signature and CRM providers, pushing portal and team updates through webhooks.",
          "Integrate email and file-storage APIs; manage service accounts and access control across cloud projects.",
          "Plan and track delivery across teams, with AI-assisted development in the daily workflow.",
          "Tune reliability with realtime data, remote configuration, and performance monitoring.",
          "Build and deploy containerized AI applications on cloud VMs, powering agentic workflows for data annotation and browser-based data crawling.",
      ...
      },
      {
        ...
        bullets: [
          "Re-architected a monolithic React frontend into a micro-frontend platform on Firebase — a host app loading around ten independently deployed apps at runtime, migrated one domain at a time with no downtime.",
          "Turned Data Science and Data Engineering research code into production Python FastAPI services with API contracts, auth, tests, and deployment pipelines.",
          "Designed and implemented CI/CD pipelines, streamlining deployment.",
          "Developed custom WordPress themes and integrated PHP scripts using a modern HTML/SASS/JS workflow.",
          "Converted local Python scripts into callable serverless APIs, modernizing backend workflows.",
          "Collaborated with developers, data engineers, data scientists, and QA specialists to deliver high-quality, scalable solutions.",
        ],
      },
    ],
    carouselImages: [
    ...
    roles: [
      {
        ...
        bullets: [
          "Built institution-wide Laravel/Livewire platforms on MySQL for research and admin processes.",
          "Hardened platforms against Remote Code Execution (RCE) and SEO poisoning via security reviews.",
          "Partnered with administrative offices and the MISO team to turn operational needs into digital tools.",
          "Iterated on system features from user feedback to keep platforms aligned with the institution’s research and development initiatives.",
          "Trained and supported faculty and staff on the systems, resolving issues and driving day-to-day adoption.",
        ],
      },
      {
        title: "Instructor I",
        period: "Aug 2022 – Jun 2025",
        bullets: [
          "Highest Rated Outstanding IT Faculty by Students, 1st and 2nd Semesters of S.Y. 2023–2024.",
          "Delivered lectures and lab classes on programming subjects; advised Capstone and OJT students.",
          "Maintained Outstanding Faculty Performance Ratings throughout the entire duration of employment.",
          ...
          "Developed instructional materials, including PowerPoint presentations and other teaching resources.",
          "Mentored students beyond official working hours to support their academic and professional growth.",
        ],
      },
    ],
    carouselImages: [
